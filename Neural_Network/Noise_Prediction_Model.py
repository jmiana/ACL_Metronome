...
plt.legend()
plt.savefig("./Neural_Network_Models/" + distro_mode + "_Epochs_vs_Loss" + ".png")
...
plt.title("w(x) predictions vs w(x) measured ")
plt.legend()
# plt.show()
plt.savefig("./Neural_Network_Models/" + distro_mode + "_w(x)_predictions_vs_w(x)_measured" + ".png")
...
plt.savefig("./Neural_Network_Models/" + distro_mode + "_Frequency_of_Measured_w(x)" + ".png")
...
plt.savefig("./Neural_Network_Models/" + distro_mode + "_Frequency_of_Predicted_w(x)" + ".png")
...
MODEL_PATH = Path("./Neural_Network_Models")
MODEL_PATH.mkdir(parents=True, exist_ok=True)

# 2. Create model save path
MODEL_NAME="UWB_NN_" + distro_mode + ".pth" #pytorch saved as .pth /.pt
#
...
print("FInished saving model state dict")
